package co.lateralview.interviewtest.infrastrcuture.manager;
...
import co.lateralview.interviewtest.application.BlinksApplication;

public class SharedPreferencesManager
{
	public static final String DEFAULT_FILE_NAME = BlinksApplication.getInstance().getPackageName() + ".sharedPreferences";
